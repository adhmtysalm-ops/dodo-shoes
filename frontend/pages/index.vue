  ...
  <div>
    ...
    <div class="relative bg-brand-gray overflow-hidden">
      ...
      <div class="relative max-w-7xl mx-auto px-6 py-32 sm:py-48 lg:py-56 flex flex-col items-start justify-center min-h-[80vh]">
        <h1 class="text-5xl md:text-8xl font-black text-brand-white uppercase tracking-tighter mb-6 max-w-3xl leading-none">
          Unleash Your <br/><span class="text-brand-red">Potential</span>
        </h1>
        <p class="mt-4 text-xl text-gray-200 max-w-xl mb-10 font-medium">
          Experience the next generation of athletic footwear. Engineered for speed, designed for champions.
        </p>
    ...
    <div id="shop" class="max-w-7xl mx-auto px-6 py-24">
      <div class="flex justify-between items-end mb-12">
        <h2 class="text-3xl md:text-5xl font-black uppercase tracking-tight">Trending Now</h2>
        <NuxtLink to="/" class="hidden md:block font-bold hover:text-brand-red transition-colors">Shop All</NuxtLink>
      </div>

      <div v-if="pending" class="py-20 text-center font-bold">Loading products...</div>
      <div v-else-if="error" class="py-20 text-center text-brand-red font-bold">Failed to load products</div>
        ...
        >
          ...
          <div class="flex justify-between items-start">
            <div>
              ...
              <p class="text-gray-500 text-sm mb-2">Men's Shoes</p>
            </div>
